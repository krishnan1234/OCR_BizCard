...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR",
                   ...
                   menu_items={'About': """# This OCR app is created by *Santhana Krishnan*!"""})
...
def app_background():
    st.markdown(f""" <style>.stApp {{
                            background-url=https://unsplash.com/photos/brown-wooden-board-h0Vxgz5tyXA;
                            }}
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"],
                       ...
                       styles={"nav-bar": { "font-size": "20px", "text-align": "centre", "margin": "20px", "--hover-color": "#AB63FA", "transition": "color 0.3s ease, background-color 0.3s ease","border-radius": "50px"},
                               "icon": {"font-size": "25px"},
                               "container" : {"max-width": "6500px", "padding": "0px", "border-radius": "50px"},
